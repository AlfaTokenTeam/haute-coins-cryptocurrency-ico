...
import "./HauteCoinsCryptocurrency.sol";

contract HauteCoinsCryptocurrencyPreSale {
    HauteCoinsCryptocurrency public token;
    ...
    function HauteCoinsCryptocurrencyPreSale(
        HauteCoinsCryptocurrency _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = HauteCoinsCryptocurrency(_token);
